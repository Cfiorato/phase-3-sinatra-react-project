...
#players
#QBs
josh_allen = Player.create(:name => "Josh Allen", :jersey_number => 17, :position => "QB", :team_id => buf.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/3918298.png')
justin_herbert = Player.create(:name => "Justin Herbert", :jersey_number => 10, :position => "QB", :team_id => lac.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/4038941.png&w=350&h=254')
tom_brady = Player.create(:name => "Tom Brady", :jersey_number => 12, :position => "QB", :team_id => ne.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/2330.png')
patrick_mahomes = Player.create(:name => "Patrick Mahomes", :jersey_number => 15, :position => "QB", :team_id => kc.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/3139477.png')
aaron_rodgers = Player.create(:name => "Aaron Rodgers", :jersey_number => 12, :position => "QB", :team_id => gb.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/8439.png')
#rbs
jonathon_taylor = Player.create(:name => "Jonathon Taylor", :jersey_number => 28, :position => "RB", :team_id => ind.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/4242335.png')
joe_mixon = Player.create(:name => "Joe Mixon", :jersey_number => 28, :position => "RB", :team_id => cin.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/3116385.png')
austin_ekeler = Player.create(:name => "Austin Ekeler", :jersey_number => 30, :position => "RB", :team_id => lac.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/3068267.png')
james_connor = Player.create(:name => "James Connor", :jersey_number => 6, :position => "RB", :team_id => ari.id, :img => 'https://a.espncdn.com/i/headshots/nfl/players/full/3045147.png')
najee_harris = Player.create(:name => "Najee Harris", :jersey_number => 22, :position => "RB", :team_id => pit.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/4241457.png')
#wrs
cooper_kupp = Player.create(:name => "Cooper Kupp", :jersey_number => 10, :position => "WR", :team_id => lar.id, :img => 'https://a.espncdn.com/i/headshots/nfl/players/full/2977187.png')
deebo_samuel = Player.create(:name => "Deebo Samuel", :jersey_number => 19, :position => "WR", :team_id => sf.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/3126486.png')
justin_jefferson = Player.create(:name => "Justin Jefferson", :jersey_number => 18, :position => "WR", :team_id => min.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/4262921.png')
davante_adams = Player.create(:name => "Davante Adams", :jersey_number => 17, :position => "WR", :team_id => gb.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/16800.png')
jamarr_chase = Player.create(:name => "Ja'Marr Chase", :jersey_number => 1, :position => "WR", :team_id => cin.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/4362628.png')
#tes 
mark_andrews = Player.create(:name => "Mark Andrews", :jersey_number => 89, :position => "TE", :team_id => bal.id, :img => 'https://a.espncdn.com/i/headshots/nfl/players/full/3116365.png')
travis_kelce = Player.create(:name => "Travis Kelce", :jersey_number => 87, :position => "TE", :team_id => kc.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/15847.png')
george_kittle = Player.create(:name => "George Kittle", :jersey_number => 85, :position => "TE", :team_id => sf.id, :img => 'https://a.espncdn.com/i/headshots/nfl/players/full/3040151.png')
dalton_schultz = Player.create(:name => "Dalton Schultz", :jersey_number => 86, :position => "TE", :team_id => dal.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/3117256.png')
zach_ertz = Player.create(:name => "Zach Ertz", :jersey_number => 86, :position => "TE", :team_id => ari.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/15835.png&w=350&h=254')
#Ks
nick_folk = Player.create(:name => "Nick Folk", :jersey_number => 2, :position => "K", :team_id => ne.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/10621.png')
matt_gay = Player.create(:name => "Matt Gay", :jersey_number => 8, :position => "K", :team_id => lar.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/4249087.png')
justin_tucker = Player.create(:name => "Justin Tucker", :jersey_number => 9, :position => "K", :team_id => bal.id, :img => 'https://a.espncdn.com/combiner/i?img=/i/headshots/nfl/players/full/15683.png')
chris_boswell = Player.create(:name => "Chris Boswell", :jersey_number => 9, :position => "K", :team_id => pit.id, :img => 'https://a.espncdn.com/i/headshots/nfl/players/full/17372.png')
daniel_carlson = Player.create(:name => "Daniel Carlson", :jersey_number => 2, :position => "K", :team_id => lv.id, :img => 'https://a.espncdn.com/i/headshots/nfl/players/full/3051909.png')
